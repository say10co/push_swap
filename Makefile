...
#    Updated: 2021/12/10 04:06:03 by adriouic         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
PUSH_FILES = $(wildcard *.c)

PUSH_OBJECS = ${PUSH_FILES:.c.o}
...
$(PUSH_SWP) : $(NAME) $(PUSH_OBJECS)
	gcc -c -l$(NAME) $(PUSH_OBJECS) -o $(PUSHSWP)

$(PUSH_OBJECS) : $(PUSH_FILES)
	gcc -c $^
bonus: $(bobjs)
